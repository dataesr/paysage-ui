...
export default function IdentifiersStep({
  ...
  return (
    <div>
        ...
        <div className="fr-notice fr-notice--info fr-mb-3w">
          <div className="fr-notice__body">
            <p className="fr-notice__title">
              {existingPersonName ? `Les identifiants de ${existingPersonName}` : 'Les identifiants de la fiche existante'}
            </p>
      ...
      {identifiers.filter((row) => row.type !== 'ark').map((row) => {
            ...
            <div style={{ display: 'flex', gap: '12px', alignItems: 'flex-start' }}>
              <div style={{ flex: '0 0 220px' }}>
                <Select
                  ...
                  hint={row.fromExisting ? 'Identifiant existant' : null}
                  selected={row.type}
