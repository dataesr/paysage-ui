  ...
  return (
    <Container spacing="pb-6w">
      ...
      <Text>
        ...
        <br />
        Yann Caradec a imaginé une solution novatrice capable de s'adapter à la constante évolution de cet écosystème et de ses données.
        <br />
        La première version du projet a permis de mettre en lumière les forces d'un tel outil. La connaissance est partagée et l'utilisateur qualifie les données.
        ...
        <br />
        <br />
        Victime de son succès, Paysage gère à présent plus de 35 000 objets.
        L'architecture logicielle a atteint ses limites et a dû être repensée afin de fournir à l'utilisateur une meilleure expérience de navigation. Naissance de la version 2.
      </Text>
      ...
      <Text>
        ...
        Le projet est maintenant entièrement développé en Javascript (NodeJS pour l'API et React pour l'interface utilisateur).
        Les données sont stockées dans MongoDb et indexées dans Elasticsearch pour la recherche.
        Le choix de ces technologies inscrit Paysage dans les outils maîtrisés par l'équipe du département des outils d'aide à la décision.
      ...
      <Text>
        Cet outil, imaginé et développé dans sa première version par Yann Caradec est dorénavant développé par l'ensemble de l'équipe du département des outils d'aide à la décision encadré par Emmanuel Weisenburger.
        Alexandra, Julia, Mialy, ... contribuent à l'enrichissement des données.
        <br />
